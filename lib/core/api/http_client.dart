...
class HttpHelper {
  ...
  static Future<Dio> _getInstance({
    ...
    _client.options.sendTimeout = connectTimeOut;
    _client.options.receiveTimeout = connectTimeOut;
  ...
  Future<dynamic> get(String route,
      ...
      onError,
      bool overrideBaseUrl = false}) async {
    ...
    if (data.runtimeType == Map ||
      ...
      if (_errorResponse.success == false) {
        ...
        return ServiceState.error(
          ServerErrorModel(statusCode: statusCode, errorMessage: _errorMessage),
        );
      }
    }
